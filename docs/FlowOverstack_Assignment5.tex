...
\section{Paper Prototyping}
	...
	\subsection{Prototype Description}
		...
		\begin{figure}[H]%
    			\centering
   			\subfloat{{\includegraphics[width=5cm]{../images/prototype1.png} }}%
   			\qquad
    			\subfloat{{\includegraphics[width=5cm]{../images/prototype2.png} }}%
		...
		\begin{figure}[H]%
    			\centering
   			\subfloat{{\includegraphics[width=5cm]{../images/prototype7.png} }}%
   			\qquad
    			\subfloat{{\includegraphics[width=5cm]{../images/prototype8.png} }}%
    			\caption{The home page (left) and the settings menu (right)}%
    			\label{homeSettings}%
		\end{figure}
		
		\begin{figure}[H]%
    			\centering
   			\subfloat{{\includegraphics[width=5cm]{../images/prototype3.png} }}%
   			\qquad
    			\subfloat{{\includegraphics[width=5cm]{../images/prototype4.png} }}%
    			\caption{A friend's profile (left) and the user's profile (right)}%
    			\label{profiles}%
		\end{figure}
		
		\begin{figure}[H]%
    			\centering
   			\subfloat{{\includegraphics[width=5cm]{../images/prototype5.png} }}%
   			\qquad
    			\subfloat{{\includegraphics[width=5cm]{../images/prototype6.png} }}%
